...
AMAZON_API = {
    'AMAZON_PRODUCT_ADVERTISING_ACCESS_KEY': os.getenv('AMAZON_PRODUCT_ADVERTISING_ACCESS_KEY'),
    'AMAZON_PRODUCT_ADVERTISING_SECRET_KEY': os.getenv('AMAZON_PRODUCT_ADVERTISING_SECRET_KEY'),
    'AMAZON_PRODUCT_ADVERTISING_REGION': os.getenv('AMAZON_PRODUCT_ADVERTISING_REGION'),
    'AMAZON_PRODUCT_ADVERTISING_ASSOCIATE_TAG': os.getenv('AMAZON_PRODUCT_ADVERTISING_ASSOCIATE_TAG'),
}

ASINDATAAPI = os.environ.get('ASINDATAAPI')
